...
?>
    <div class="clearfix card">
        ...
        <div class="clearfix container_card">
            <div class="clearfix tabla_container_card">
                <div class="clearfix fila_container_card">
                    <a class="enlace_simple" href="votacion.php?idpartido=13">Votaciones Jornada 13--></a>
                </div>
                <div class="clearfix fila_container_card">
                    <a class="enlace_simple" href="votacion.php?idpartido=14">Votaciones Jornada 14--></a>
                </div>
                <div class="clearfix fila_container_card">
                    <a id="nuevo" class="enlace_simple" href="votacion.php?idpartido=14">Votaciones Jornada 15--></a>
                </div>
                <div class="clearfix fila_container_card">
                ...
                <div class="clearfix fila_container_card">
                    <a class="enlace_simple" href="votacion.php?idpartido=10">Datos Jornada 10--></a>
                </div>
                <div class="clearfix fila_container_card">
                    <a class="enlace_simple" href="votacion.php?idpartido=11">Datos Jornada 11--></a>
                </div>
                <div class="clearfix fila_container_card">
                    <a class="enlace_simple" href="votacion.php?idpartido=12">Datos Jornada 12--></a>
                </div>
            </div>
        </div>
    </div>
